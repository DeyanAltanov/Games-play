...
from games_play.games.views import home, create_profile, dashboard, create_game, details_game, edit_game, delete_game, \
...
urlpatterns = [
    ...
    path('game/create/<int:pk>', details_game, name='details game'),
